...
@Component({
  selector: 'app-service-detail-or',
  templateUrl: './service-detail-or.component.html',
  styleUrls: ['./service-detail-or.component.css']
})
export class ServiceDetailOrComponent implements OnInit {
  public uid;
  public basic;
  public account;
  public comments = [];
