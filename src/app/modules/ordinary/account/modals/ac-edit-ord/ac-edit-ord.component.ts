...
@Component({
  selector: 'app-ac-edit-ord',
  templateUrl: './ac-edit-ord.component.html',
  styleUrls: ['./ac-edit-ord.component.css']
})
export class AcEditOrdComponent implements OnInit {
  @Input()
  currentData;
  ...
  save() {
    ...
    // console.log(post);
    this.accountService.updateConfigO(post)
      .subscribe(val => {
        Swal(
          '操作成功！',
          '',
