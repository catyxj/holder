...
@Component({
  selector: 'app-address-add-purchase-dir',
  templateUrl: './address-add-purchase-dir.component.html',
  styleUrls: ['./address-add-purchase-dir.component.css']
})
export class AddressAddPurchaseDirComponent implements OnInit {
  public name;
  public address;
  public contact;
