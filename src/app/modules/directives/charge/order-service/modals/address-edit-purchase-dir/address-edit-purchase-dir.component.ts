...
@Component({
  selector: 'app-address-edit-purchase-dir',
  templateUrl: './address-edit-purchase-dir.component.html',
  styleUrls: ['./address-edit-purchase-dir.component.css']
})
export class AddressEditPurchaseDirComponent implements OnInit {
  @Input()
  currentData;
