...
@Component({
  selector: 'app-m-temp-batch-delete-f',
  templateUrl: './m-temp-batch-delete-f.component.html',
  styleUrls: ['./m-temp-batch-delete-f.component.css']
})
export class MTempBatchDeleteFComponent implements OnInit {
  public dataLists = [];
  public page = 1;
  public pageNum;
  public pageSize = 15;
