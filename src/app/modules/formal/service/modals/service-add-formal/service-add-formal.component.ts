...
@Component({
  selector: 'app-service-add-formal',
  templateUrl: './service-add-formal.component.html',
  styleUrls: ['./service-add-formal.component.css']
})
export class ServiceAddFormalComponent implements OnInit {
  public type = '2';
  public content;
  public fileList = [];
