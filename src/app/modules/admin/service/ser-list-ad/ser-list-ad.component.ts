...
@Component({
  ...
  templateUrl: './ser-list-ad.component.html',
  styleUrls: ['./ser-list-ad.component.css']
})
export class SerListAdComponent implements OnInit {
  public serviceList = [];
  public page = 1;
  public pageNum;
  public pageSize = 15;
  ...
  checkBatch(checked) {
    ...
    this.loading = true;
    this.serviceService.closeData(post)
      .subscribe(val => {
        that.loading = false;
        Swal(
          '操作成功！',
