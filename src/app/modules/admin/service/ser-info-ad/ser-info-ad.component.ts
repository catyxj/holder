...
@Component({
  ...
  templateUrl: './ser-info-ad.component.html',
  styleUrls: ['./ser-info-ad.component.css']
})
export class SerInfoAdComponent implements OnInit {
  public uid;
  public basic;
  public account;
  public comments = [];
  ...
  // 获取基础信息
  getBasic() {
    this.serviceService.getBasic(this.uid)
      .subscribe(data => {
        this.basic = data;
  ...
  getComments() {
    ...
    this.serviceService.getComments(this.uid, this.page, this.pageSize)
      .subscribe(data => {
  ...
  filters: UploadFilter[] = [
    {
      ...
      fn: (fileList: UploadFile[]) => {
        if (this.fileList.length < 5 && fileList[0].size < 2097152) {
          return fileList;
        } else {
          Swal(
            '上传失败',
