...
@Component({
  selector: 'app-ter-operate-ad',
  templateUrl: './ter-operate-ad.component.html',
  styleUrls: ['./ter-operate-ad.component.css']
})
export class TerOperateAdComponent implements OnInit {
  public uid;
  public name;
  public operateList = [];
  public page = 1;
