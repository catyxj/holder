...
@Component({
  ...
  templateUrl: './ter-list-ad.component.html',
  styleUrls: ['./ter-list-ad.component.css']
})
export class TerListAdComponent implements OnInit {
  public dataLists = [];
  public page = 1;
  public pageNum;
  public pageSize = 15;
  ...
  ngOnInit() {
    // this.router.navigate(['/admin/user-account', { status: status}]);
  ...
  addTerm() {
    let that = this;
    const modalRef = this.modalService.open(TerAddAdComponent, {windowClass: 'modal_md', centered: true});
  ...
  batchAdd() {
    let that = this;
    const modalRef = this.modalService.open(TerBatchAddAdComponent, {windowClass: 'modal_md', centered: true});
