...
import {BlueAddAdComponent} from "../modals/blue-add-ad/blue-add-ad.component";
...
@Component({
  selector: 'app-blue-list-ad',
  templateUrl: './blue-list-ad.component.html',
  styleUrls: ['./blue-list-ad.component.css']
})
export class BlueListAdComponent implements OnInit {
  public dataLists = [];
  public page = 1;
  public pageNum;
  public pageSize = 15;
  ...
  addData() {
    let that = this;
    const modalRef = this.modalService.open(BlueAddAdComponent, {windowClass: 'modal_md', centered: true});
