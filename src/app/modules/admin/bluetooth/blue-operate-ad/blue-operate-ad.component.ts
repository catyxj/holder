...
@Component({
  selector: 'app-blue-operate-ad',
  templateUrl: './blue-operate-ad.component.html',
  styleUrls: ['./blue-operate-ad.component.css']
})
export class BlueOperateAdComponent implements OnInit {
  public uid;
  public name;
  public operateList;
  public page = 1;
