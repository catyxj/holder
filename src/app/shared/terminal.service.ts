...
export class TerminalService {
  ...
  private dataTypeUrl = 'assets/server/baud_rate_list.json';
  ...
  private chanList = '/channel_config_list';
  private rollback = '/channel_config_rollback';
  ...
  saveItem(data): Observable<any> {
    return this.http.post('/channel_item_update', data, httpOptions)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  deleteItem(data): Observable<any> {
    return this.http.post('/channel_item_delete', data, httpOptions)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  // 版本回退
  rollbackConfig(): Observable<any> {
    return this.http.get<any>(this.rollback)
      .pipe(
        catchError(this.handleError)
      );
  }
